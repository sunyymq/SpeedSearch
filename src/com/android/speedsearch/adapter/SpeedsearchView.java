...
public class SpeedsearchView extends ViewGroup {
    private static final String TAG = "SpeedsearchView";
    ...
    public SpeedsearchView(Context context) {
        super(context);
        Log.i(TAG, "SpecailView()");
    }

    public SpeedsearchView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        Log.i(TAG, "SpecailView( , , )");
    }

    public SpeedsearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.i(TAG, "SpecailView( , )");
    }
...
//        }
    ...
    public void setOnItemClick(Speedbutton.OnClickListener l) {
        int count = getChildCount();
        for (int i = 0; i < count; i++) {
            ((Speedbutton)getChildAt(i)).setOnClickListener(l);
        }
    }

    private ArrayList<CircleCenteter> centers = new ArrayList<SpeedsearchView.CircleCenteter>(7);
