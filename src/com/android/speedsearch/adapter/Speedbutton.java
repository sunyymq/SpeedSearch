...
public class Speedbutton extends TextView implements View.OnClickListener {
    private static final String TAG = "Speedbutton";
...
//        paint.setTextSize(textSize);
    ...
    public void onClick(View v) {
        checked = !checked;
        //setBackgroundResource(R.drawable.logo_s);
